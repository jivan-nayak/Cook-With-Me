from tkinter import *
import ChineseCuisine
import ItalianCuisine
import FrenchCuisine
import IndianCuisine
...
def onclickitalian():
    master.destroy()
    ItalianCuisine.begin()


def onclickchinese():
    master.destroy()
    ChineseCuisine.begin()


def begin():
    # Master Window with background images and icon
    global master
    master = Tk()
    ...
    img1 = PhotoImage(
        file="C:/Users/Jivan/Desktop/Mini Project/sem 5/Code/imgaes/ind.png")
